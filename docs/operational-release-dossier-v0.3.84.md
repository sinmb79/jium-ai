...
The required review manifest also lists the server origin candidate, trusted-key approval candidate, desktop publish candidate, operational approval command packet, operational launch console, and operational approval input template reports when those redacted packets are generated.
